...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "program$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "program$subexpression$1$ebnf$1", "symbols": ["program$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "program$subexpression$1", "symbols": ["program$subexpression$1$ebnf$1"]},
    {"name": "program$subexpression$1", "symbols": ["_"]},
    {"name": "program$ebnf$1$subexpression$1", "symbols": ["functions"]},
    {"name": "program$ebnf$1$subexpression$1", "symbols": ["component"]},
    ...
    {"name": "program", "symbols": ["program$subexpression$1", "libs", "declarations", "program$ebnf$1"], "postprocess": ast.xprogram},
    {"name": "libs", "symbols": []},
    {"name": "libs$ebnf$1", "symbols": []},
    {"name": "libs$ebnf$1$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "libs$ebnf$1$subexpression$1$ebnf$1", "symbols": ["libs$ebnf$1$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "libs$ebnf$1$subexpression$1", "symbols": ["libs$ebnf$1$subexpression$1$ebnf$1", "library"]},
    {"name": "libs$ebnf$1", "symbols": ["libs$ebnf$1", "libs$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "libs$ebnf$2", "symbols": ["NL"]},
    {"name": "libs$ebnf$2", "symbols": ["libs$ebnf$2", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "libs", "symbols": ["library", "libs$ebnf$1", "libs$ebnf$2"], "postprocess": tailList(0, 1, 1)},
    {"name": "library", "symbols": [{type: "library"}, "__", "string"], "postprocess": ast.lib},
    {"name": "functions$ebnf$1$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "functions$ebnf$1$subexpression$1$ebnf$1", "symbols": ["functions$ebnf$1$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "functions$ebnf$1$subexpression$1", "symbols": ["function", "functions$ebnf$1$subexpression$1$ebnf$1"]},
    {"name": "functions$ebnf$1", "symbols": ["functions$ebnf$1$subexpression$1"]},
    {"name": "functions$ebnf$1$subexpression$2$ebnf$1", "symbols": ["NL"]},
    {"name": "functions$ebnf$1$subexpression$2$ebnf$1", "symbols": ["functions$ebnf$1$subexpression$2$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "functions$ebnf$1$subexpression$2", "symbols": ["function", "functions$ebnf$1$subexpression$2$ebnf$1"]},
    ...
    {"name": "functions", "symbols": ["functions$ebnf$1"], "postprocess": list(0, 1)},
    {"name": "functions$ebnf$2", "symbols": ["NL"]},
    {"name": "functions$ebnf$2", "symbols": ["functions$ebnf$2", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "functions", "symbols": ["component", "functions$ebnf$2"], "postprocess": id},
    {"name": "function", "symbols": ["func"], "postprocess": id},
    {"name": "function", "symbols": ["sub"], "postprocess": id},
    {"name": "func", "symbols": [{type: "function"}, "__", "NAME", "_", {"literal":"("}, "params", {"literal":")"}, "__", {type: "as"}, "__", "xtype", "statement_list", {type: "end"}, "__", {type: "function"}], "postprocess": ast.xfunc},
    {"name": "sub$subexpression$1", "symbols": [{type: "end"}, "__", {type: "sub"}]},
    {"name": "sub", "symbols": [{type: "sub"}, "__", "NAME", "_", {"literal":"("}, "params", {"literal":")"}, "statement_list", "sub$subexpression$1"], "postprocess": ast.xfunc},
    {"name": "anonymous_function", "symbols": [{type: "function"}, "_", {"literal":"("}, "params", {"literal":")"}, "__", {type: "as"}, "__", "xtype", "statement_list", {type: "end"}, "__", {type: "function"}], "postprocess": ast.xfunc},
    {"name": "anonymous_function", "symbols": [{type: "sub"}, "_", {"literal":"("}, "params", {"literal":")"}, "statement_list", {type: "end"}, "__", {type: "sub"}], "postprocess": ast.xfunc},
    ...
    {"name": "param_type", "symbols": ["_", {type: "as"}, "__", "xtype"]},
    ...
    {"name": "ANYID", "symbols": ["IDENTIFIER"], "postprocess": id},
    {"name": "ANYID", "symbols": ["constant"], "postprocess": id},
    {"name": "ANYID", "symbols": ["RESERVED"], "postprocess": id},
    {"name": "NL", "symbols": ["comment"], "postprocess": id},
    ...
    {"name": "declarations$ebnf$1", "symbols": []},
    {"name": "declarations$ebnf$1$subexpression$1$subexpression$1", "symbols": ["interface"]},
    {"name": "declarations$ebnf$1$subexpression$1$subexpression$1", "symbols": ["enum"]},
    {"name": "declarations$ebnf$1$subexpression$1$subexpression$1", "symbols": ["typedef"]},
    {"name": "declarations$ebnf$1$subexpression$1$subexpression$1", "symbols": ["func_decl"]},
    {"name": "declarations$ebnf$1$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "declarations$ebnf$1$subexpression$1$ebnf$1", "symbols": ["declarations$ebnf$1$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "declarations$ebnf$1$subexpression$1", "symbols": ["declarations$ebnf$1$subexpression$1$subexpression$1", "declarations$ebnf$1$subexpression$1$ebnf$1"]},
    {"name": "declarations$ebnf$1", "symbols": ["declarations$ebnf$1", "declarations$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "declarations", "symbols": ["declarations$ebnf$1"], "postprocess": list(0, 0)},
    {"name": "interface$ebnf$1$subexpression$1", "symbols": [{"literal":"<"}, "templates", {"literal":">"}]},
    {"name": "interface$ebnf$1", "symbols": ["interface$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "interface$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "interface$ebnf$2$subexpression$1", "symbols": ["__", {"literal":"extends"}, "__", "NAME"]},
    ...
    {"name": "interface_members$ebnf$1$subexpression$1", "symbols": ["interface_members$ebnf$1$subexpression$1$ebnf$1", "interface_member"]},
    ...
    {"name": "interface_members$ebnf$2", "symbols": ["NL"]},
    {"name": "interface_members$ebnf$2", "symbols": ["interface_members$ebnf$2", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "interface_members", "symbols": ["interface_members$ebnf$1", "interface_members$ebnf$2"]},
    {"name": "interface_member$ebnf$1$subexpression$1", "symbols": [{"literal":"readonly"}, "__"]},
    ...
    {"name": "interface_member", "symbols": ["interface_member$ebnf$1", "NAME", "__", {"literal":"as"}, "__", "xtype"], "postprocess": ast.iproperty},
    {"name": "interface_member", "symbols": ["func_decl"], "postprocess": id},
    ...
    {"name": "func_decl", "symbols": [{"literal":"function"}, "__", "NAME", "_", {"literal":"("}, "xparams", {"literal":")"}, "func_decl$ebnf$1"], "postprocess": ast.ifunction},
    {"name": "enum", "symbols": [{"literal":"enum"}, "__", "NAME", "enum_members", {"literal":"end"}, "__", {"literal":"enum"}], "postprocess": ast.enum},
    {"name": "enum_members$ebnf$1", "symbols": []},
    {"name": "enum_members$ebnf$1$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "enum_members$ebnf$1$subexpression$1$ebnf$1", "symbols": ["enum_members$ebnf$1$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "enum_members$ebnf$1$subexpression$1", "symbols": ["enum_members$ebnf$1$subexpression$1$ebnf$1", "enum_member"]},
    ...
    {"name": "enum_members$ebnf$2", "symbols": ["NL"]},
    {"name": "enum_members$ebnf$2", "symbols": ["enum_members$ebnf$2", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "enum_members", "symbols": ["enum_members$ebnf$1", "enum_members$ebnf$2"]},
    {"name": "enum_member$ebnf$1$subexpression$1$subexpression$1", "symbols": ["string"]},
    {"name": "enum_member$ebnf$1$subexpression$1$subexpression$1", "symbols": ["number"]},
    {"name": "enum_member$ebnf$1$subexpression$1", "symbols": ["_", {"literal":"="}, "_", "enum_member$ebnf$1$subexpression$1$subexpression$1"]},
    {"name": "enum_member$ebnf$1", "symbols": ["enum_member$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "enum_member$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "enum_member", "symbols": ["ANYID", "enum_member$ebnf$1"], "postprocess": ast.enummember},
    {"name": "xtype_list$ebnf$1", "symbols": []},
    {"name": "xtype_list$ebnf$1$subexpression$1", "symbols": [{"literal":","}, "_", "xtype"]},
    {"name": "xtype_list$ebnf$1", "symbols": ["xtype_list$ebnf$1", "xtype_list$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "xtype_list", "symbols": ["_", "xtype", "xtype_list$ebnf$1", "_"], "postprocess": tailList(1, 2, 2)},
    {"name": "xtype_list2$ebnf$1$subexpression$1", "symbols": [{"literal":","}, "_", "xtype"]},
    {"name": "xtype_list2$ebnf$1", "symbols": ["xtype_list2$ebnf$1$subexpression$1"]},
    {"name": "xtype_list2$ebnf$1$subexpression$2", "symbols": [{"literal":","}, "_", "xtype"]},
    {"name": "xtype_list2$ebnf$1", "symbols": ["xtype_list2$ebnf$1", "xtype_list2$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "xtype_list2", "symbols": ["_", "xtype", "xtype_list2$ebnf$1", "_"], "postprocess": tailList(1, 2, 2)},
    {"name": "xtype_list0", "symbols": ["xtype_list"], "postprocess": id},
    ...
    {"name": "otype", "symbols": ["named_type"], "postprocess": id},
    {"name": "otype", "symbols": ["array_type"], "postprocess": id},
    {"name": "otype", "symbols": ["tuple_type"], "postprocess": id},
    {"name": "otype", "symbols": ["obj_type"], "postprocess": id},
    {"name": "named_type", "symbols": ["IDENTIFIER"], "postprocess": ast.namedType},
    {"name": "array_type", "symbols": [{"literal":"["}, "_", "xtype", "_", {"literal":"]"}], "postprocess": ast.arrayType},
    {"name": "tuple_type", "symbols": [{"literal":"["}, "xtype_list2", {"literal":"]"}], "postprocess": ast.tupleType},
    {"name": "func_type", "symbols": [{"literal":"("}, "xtype_list0", {"literal":")"}, "_", {"literal":"->"}, "_", "xtype"], "postprocess": ast.funcType},
    {"name": "obj_type$ebnf$1", "symbols": []},
    {"name": "obj_type$ebnf$1$subexpression$1$subexpression$1", "symbols": ["NL"]},
    {"name": "obj_type$ebnf$1$subexpression$1$subexpression$1", "symbols": [{"literal":","}, "__"]},
    {"name": "obj_type$ebnf$1$subexpression$1", "symbols": ["obj_type$ebnf$1$subexpression$1$subexpression$1", "obj_prop"]},
    {"name": "obj_type$ebnf$1", "symbols": ["obj_type$ebnf$1", "obj_type$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "obj_type", "symbols": [{"literal":"{"}, "__NL", "obj_prop", "obj_type$ebnf$1", "__NL", {"literal":"}"}], "postprocess": ast.objType},
    {"name": "obj_prop", "symbols": ["PROP_NAME", {"literal":":"}, "__", "xtype"], "postprocess": ast.objProp},
    {"name": "__NL", "symbols": ["__"]},
    {"name": "__NL$ebnf$1", "symbols": ["NL"]},
    {"name": "__NL$ebnf$1", "symbols": ["__NL$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "__NL", "symbols": ["__NL$ebnf$1"]},
    {"name": "typedef", "symbols": [{"literal":"typedef"}, "__", "NAME", "_", {"literal":"="}, "_", "xtype"], "postprocess": ast.typedef},
    {"name": "component", "symbols": [{"literal":"component"}, "__", "NAME", "__", {"literal":"extends"}, "__", "NAME", "component_members", {"literal":"end"}, "__", {"literal":"component"}], "postprocess": ast.component},
    {"name": "component_members$ebnf$1", "symbols": []},
    {"name": "component_members$ebnf$1$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "component_members$ebnf$1$subexpression$1$ebnf$1", "symbols": ["component_members$ebnf$1$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "component_members$ebnf$1$subexpression$1", "symbols": ["component_members$ebnf$1$subexpression$1$ebnf$1", "component_member"]},
    {"name": "component_members$ebnf$1", "symbols": ["component_members$ebnf$1", "component_members$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "component_members$ebnf$2", "symbols": ["NL"]},
    {"name": "component_members$ebnf$2", "symbols": ["component_members$ebnf$2", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "component_members", "symbols": ["component_members$ebnf$1", "component_members$ebnf$2"]},
    {"name": "attribute$ebnf$1$subexpression$1", "symbols": ["_", {"literal":"("}, "_", "expression_list", "_", {"literal":")"}]},
    ...
    {"name": "attribute", "symbols": [{"literal":"@"}, "NAME", "attribute$ebnf$1"], "postprocess": ast.attribute},
    {"name": "attributes$ebnf$1", "symbols": []},
    {"name": "attributes$ebnf$1$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "attributes$ebnf$1$subexpression$1$ebnf$1", "symbols": ["attributes$ebnf$1$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "attributes$ebnf$1$subexpression$1", "symbols": ["attribute", "attributes$ebnf$1$subexpression$1$ebnf$1"]},
    ...
    {"name": "attributes", "symbols": ["attributes$ebnf$1"], "postprocess": list(0, 0)},
    {"name": "component_member$ebnf$1$subexpression$1", "symbols": [{"literal":"public"}, "__"]},
    {"name": "component_member$ebnf$1", "symbols": ["component_member$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "component_member$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "component_member$ebnf$2$subexpression$1", "symbols": [{"literal":"readonly"}, "__"]},
    {"name": "component_member$ebnf$2", "symbols": ["component_member$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "component_member$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "component_member", "symbols": ["attributes", "component_member$ebnf$1", "component_member$ebnf$2", "NAME", "__", {"literal":"as"}, "__", "xtype"], "postprocess": ast.cproperty},
    {"name": "component_member$ebnf$3$subexpression$1", "symbols": [{"literal":"public"}, "__"]},
    {"name": "component_member$ebnf$3", "symbols": ["component_member$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "component_member$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "component_member", "symbols": ["attributes", "component_member$ebnf$3", "function"], "postprocess": ast.cfunc}
]
  , ParserStart: "program"
}
