...
var grammar = {
    ...
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$1$ebnf$1", "symbols": ["NL"]},
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$1$ebnf$1", "symbols": ["xdeclaration$ebnf$1$subexpression$1$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$1", "symbols": ["xdeclaration$ebnf$1$subexpression$1$subexpression$1$ebnf$1"]},
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$1", "symbols": ["_"]},
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$2", "symbols": ["interface"]},
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$2", "symbols": ["enum"]},
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$2", "symbols": ["typedef"]},
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$2", "symbols": ["func_decl"]},
    {"name": "xdeclaration$ebnf$1$subexpression$1", "symbols": ["xdeclaration$ebnf$1$subexpression$1$subexpression$1", "xdeclaration$ebnf$1$subexpression$1$subexpression$2"]},
    ...
    {"name": "xdeclaration$subexpression$1$ebnf$1", "symbols": []},
    {"name": "xdeclaration$subexpression$1$ebnf$1", "symbols": ["xdeclaration$subexpression$1$ebnf$1", "NL"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "xdeclaration$subexpression$1", "symbols": ["xdeclaration$subexpression$1$ebnf$1"]},
    {"name": "xdeclaration$subexpression$1", "symbols": ["__"]},
    {"name": "xdeclaration", "symbols": ["xdeclaration$ebnf$1", "xdeclaration$subexpression$1"], "postprocess": ast.declarations},
    ...
    {"name": "interface_member$ebnf$2$subexpression$1", "symbols": [{"literal":"property"}, "__"]},
    {"name": "interface_member$ebnf$2", "symbols": ["interface_member$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "interface_member$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "interface_member", "symbols": ["interface_member$ebnf$1", "interface_member$ebnf$2", "NAME", "__", {"literal":"as"}, "__", "xtype"], "postprocess": ast.iproperty},
