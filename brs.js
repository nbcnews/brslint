...
var grammar = {
    ...
    {"name": "param_default", "symbols": ["_", {"literal":"="}, "_", "rval"], "postprocess": n(3)},
    {"name": "param_type", "symbols": ["_", {"literal":"as"}, "__", "ptype"], "postprocess": n(3)},
    {"name": "ptype", "symbols": ["type"], "postprocess": id},
    {"name": "ptype", "symbols": [{"literal":"function"}]},
    {"name": "rtype", "symbols": ["type"], "postprocess": id},
    {"name": "rtype", "symbols": [{"literal":"void"}]},
    ...
    {"name": "statement_separators", "symbols": ["statement_separators$ebnf$1"]},
    {"name": "statement_separator", "symbols": ["NL"]},
    {"name": "statement_separator", "symbols": ["_", {"literal":":"}, "_"]},
    ...
    {"name": "else_if", "symbols": ["elseif", "if_body"], "postprocess": flat},
    ...
    {"name": "elseif", "symbols": [{"literal":"else"}, "__", {"literal":"if"}], "postprocess": id},
    {"name": "elseif", "symbols": [{"literal":"elseif"}], "postprocess": id},
    {"name": "endif", "symbols": [{"literal":"end"}, "__", {"literal":"if"}], "postprocess": id},
    {"name": "endif", "symbols": [{"literal":"endif"}], "postprocess": id},
    {"name": "oneline_if$ebnf$1$subexpression$1", "symbols": [{"literal":"then"}, "_"]},
    ...
    {"name": "oneline_if$ebnf$2$subexpression$1", "symbols": ["__", {"literal":"else"}, "__", "oneline_statement"]},
    ...
    {"name": "oneline_if", "symbols": [{"literal":"if"}, "_", "EXPR", "_", "oneline_if$ebnf$1", "oneline_statement", "oneline_if$ebnf$2"], "postprocess": ast.oneline_if},
    {"name": "statement_list_or_space", "symbols": ["statement_list"]},
    {"name": "statement_list_or_space", "symbols": ["__"]},
    ...
    {"name": "for_each", "symbols": [{"literal":"for"}, "_", {"literal":"each"}, "__", "IDENTIFIER", "__", {"literal":"in"}, "_", "rval", "_", "statement_list", "end_for_each"], "postprocess": ast.foreach},
    ...
    {"name": "while_loop", "symbols": [{"literal":"while"}, "_", "EXPR", "_", "statement_list", "while_loop$subexpression$1"], "postprocess": ast.while},
    ...
    {"name": "call", "symbols": ["_", {"literal":"("}, "call_args", {"literal":")"}], "postprocess": ast.call},
    {"name": "call_args", "symbols": ["_"], "postprocess": ast.callargs},
    {"name": "call_args$ebnf$1", "symbols": []},
    {"name": "call_args$ebnf$1$subexpression$1", "symbols": ["rval", "_", {"literal":","}, "_"]},
    ...
    {"name": "call_args", "symbols": ["_", "call_args$ebnf$1", "rval", "_"], "postprocess": ast.callargs},
