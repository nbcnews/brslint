...
var grammar = {
    ...
    {"name": "xdeclaration$ebnf$1$subexpression$1$subexpression$1$ebnf$1", "symbols": []},
    ...
    {"name": "interface$ebnf$1$subexpression$1", "symbols": ["__", {"literal":"extends"}, "__", "NAME"]},
    ...
    {"name": "interface", "symbols": [{"literal":"interface"}, "__", "NAME", "interface$ebnf$1", "interface_members", {"literal":"end"}, "__", {"literal":"interface"}], "postprocess": ast.interface},
    ...
    {"name": "interface_member", "symbols": [{"literal":"property"}, "__", "NAME", "__", {"literal":"as"}, "__", "xtype"], "postprocess": ast.iproperty},
    {"name": "interface_member$ebnf$1$subexpression$1", "symbols": ["__", {"literal":"as"}, "__", "xtype"]},
    ...
    {"name": "interface_member", "symbols": [{"literal":"function"}, "__", "NAME", "_", {"literal":"("}, "xparams", {"literal":")"}, "interface_member$ebnf$1"], "postprocess": ast.ifunction},
    ...
    {"name": "enum_member", "symbols": ["NAME", "enum_member$ebnf$1"], "postprocess": ast.enummember},
    {"name": "xtype_list$ebnf$1", "symbols": []},
    {"name": "xtype_list$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "xtype"]},
    ...
    {"name": "xtype_list", "symbols": ["_", "xtype", "xtype_list$ebnf$1", "_"], "postprocess": ast.typeList},
    {"name": "xtype_list2$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "xtype"]},
    {"name": "xtype_list2$ebnf$1", "symbols": ["xtype_list2$ebnf$1$subexpression$1"]},
    {"name": "xtype_list2$ebnf$1$subexpression$2", "symbols": ["_", {"literal":","}, "_", "xtype"]},
    ...
    {"name": "xtype_list2", "symbols": ["_", "xtype", "xtype_list2$ebnf$1", "_"], "postprocess": ast.typeList},
